...
commands to get your book uploaded ^[Assuming git is installed, these would be `git remote add origin https://github.com/USERNAME/REPOSITORY.git`, 
`git branch -M main`, and `git push -u origin main`].
If you wish to avoid the scary terminal, install [GitHub Desktop](https://desktop.github.com), 
choose *Add existing repository*, point it at your book folder, and press *Publish repository*.
